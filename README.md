...
> Ensure that you build Vigil using Rust `nightly-2018-12-14` (use the `nightly` toolchain). Some Vigil dependencies may not compile with later versions of the compiler.
