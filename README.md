...
_Tested at Rust version: `rustc version 1.42.0-nightly (1ed41b072 2020-01-01)`
...
```bash
docker pull valeriansaliou/vigil:v1.13.0
```
...
```bash
docker run -p 8080:8080 -v /path/to/your/vigil/config.cfg:/etc/vigil.cfg valeriansaliou/vigil:v1.13.0
```
