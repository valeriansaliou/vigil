...
_Tested at Rust version: `rustc 1.46.0-nightly (7750c3d46 2020-06-26)`_
...
```bash
docker pull valeriansaliou/vigil:v1.17.0
```
...
```bash
docker run -p 8080:8080 -v /path/to/your/vigil/config.cfg:/etc/vigil.cfg valeriansaliou/vigil:v1.17.0
```
